...
def main():
    ...
    eval_conformal_proto(test_file, dev_file, epsilon, xmax, ymax, normalize)


def eval_conformal_proto(test_file, dev_file, epsilon, xmax, ymax, normalize, plot=True):
    ...
    print(dev_confs.shape, dev_pred_probs.shape)
    print(test_confs.shape, test_pred_probs.shape)
    ...
    if plot:
        ...
        ax.set_ylim(0, ymax)
        plt.savefig('hist_proto_probs.pdf')
